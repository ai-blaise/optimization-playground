...
class CommonKVSender(BaseKVSender):
    ...
    def _prepare_send_indices(
        ...
        # NOTE(ai-blaise merge): preserve layersplit PD transfer gate from HEAD.
        # Layersplit transfer needs the full per-rank kv_indices, so do not
        # filter them down to this CP rank's slice.
        if (
