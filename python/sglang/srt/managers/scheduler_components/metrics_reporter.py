...
class SchedulerMetricsReporter:
    ...
    def report_decode_stats(
        ...
        if self.scheduler.spec_algorithm.is_none() or self.spec_num_forward_ct <= 0:
            ...
            if self.scheduler.spec_algorithm.is_smc():
                draft_per_round = self.scheduler.server_args.smc_gamma
            elif self.scheduler.server_args.speculative_num_draft_tokens:
                draft_per_round = (
